...
namespace HwInf.Services.PdfService.TemplateService
{
    public class TemplateService : ITemplateService
    {
        ...
        public string RenderTemplateAsync<TViewModel>(string filename, TViewModel viewModel)
        {
            ...
            using (var outputWriter = new PdfStringWriter())
            {
