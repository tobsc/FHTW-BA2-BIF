...
const ADMIN_ROUTES: Routes = [
    { path: 'admin', component: HomeComponent, canActivate: [AuthGuard , VerwalterGuard],
        children: [
            ...
            { path: 'geraete/verwalten/:id', component: DeviceEditComponent },
            { path: 'geraete/erstellen', component: DeviceAddComponent },
            { path: 'geraete/erstellen/:id', component: DeviceDuplicateComponent },
            ...
            {path: 'schaden', component: DamagesComponent},
